...
namespace UnityEngine
{
	...
	[AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = false)]
	public sealed class AssetReferenceUITypeRestriction : AssetReferenceUIRestriction
	{
		private Type type;
		...
		{
			#if UNITY_EDITOR
			return ValidateAsset(AssetDatabase.LoadAssetAtPath<Object>(path));
			#else
            return true;
			#endif
		}

		public AssetReferenceUITypeRestriction(Type type)
		{
			this.type = type;
		}
	}
